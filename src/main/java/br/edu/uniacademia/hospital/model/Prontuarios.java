...
@XmlRootElement
@NamedQueries({ @NamedQuery(name = "Prontuarios.findAll", query = "SELECT p FROM Prontuarios p"),
...
public class Prontuarios implements Serializable {
	...
	public boolean equals(Object object) {
		...
		if ((this.idProntuario == null && other.idProntuario != null)
				|| (this.idProntuario != null && !this.idProntuario.equals(other.idProntuario))) {
			return false;
		}
	...
	public String toString() {
		return "Prontuarios [idProntuario=" + idProntuario + ", data=" + data + ", descricao=" + descricao
				+ ", observacoes=" + observacoes + ", funcionariosidFuncionario=" + funcionariosidFuncionario
				+ ", pacientesidPaciente=" + pacientesidPaciente + "]";
	}
}
